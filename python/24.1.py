...
def solve(edges, conn, strength):
    # We care about the maxium strength seen, set to the
    # incoming strength.  If we find no edges to traverse
    # this is a leaf and we need to return this value
    ...
    for a, b in edges:
        ...
        new_strength = solve(new_edges, next_conn, new_strength)
        # Update the max strength if needed
